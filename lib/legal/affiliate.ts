...
const fr: LegalPage = {
  ...
  lastUpdated: "Dernière mise à jour : 27/08/2026",
...
const en: LegalPage = {
  ...
  lastUpdated: "Last updated: 08/27/2026",
...
const es: LegalPage = {
  ...
  lastUpdated: "Última actualización: 27/08/2026",
...
const it: LegalPage = {
  ...
  lastUpdated: "Ultimo aggiornamento: 27/08/2026",
...
const ar: LegalPage = {
  ...
  lastUpdated: "آخر تحديث: 27/08/2026",
  ...
  sections: [
    ...
    { h: "المادة 3 - آلية العمل", body: ["يحصل كل شريك على رمز عام وروابط فريدة، متاحة في مساحته الخاصة. يحدد ملف تعريف ارتباط الشريك عند النقر. تبقى الروابط الصادرة سابقًا عبر Systeme.io صالحة ويستمر تتبعها. تُمنح العمولات وفقًا للشروط في حالة البيع."] },
    { h: "المادة 4 - ملفات تعريف الارتباط والإسناد", body: ["يعتمد التتبع على ملف تعريف ارتباط يُودَع عند النقر، مدته اثنا عشر (12) شهرًا، بشرط الاحتفاظ به على جهاز المستخدم وعدم حذفه. التسجيل المجاني عبر رابط شراكة يربط المسجَّل بذلك الشريك بشكل دائم، دون حد زمني. لا يضمن الناشر إسنادًا مثاليًا للمبيعات. في حالة النزاع، يحدد الناشر الإسناد بشكل سيادي."] },
    ...
    { h: "المادة 6 - الدفع", body: ["تصبح العمولة قابلة للدفع بعد ثلاثين (30) يومًا من تحصيل دفعة العميل. تُسدَّد العمولات القابلة للدفع بين 10 و13 من كل شهر، بتحويل SEPA أو عبر PayPal حسب اختيار الشريك، إلى البيانات المسجَّلة في مساحته. ينطبق حد أدنى قدره عشرون (20) يورو: دون ذلك يبقى المبلغ مكتسبًا للشريك ويُرحَّل إلى الدفعة التالية. تستمر عمولات المبيعات السابقة التي تمت عبر مسارات Systeme.io في الدفع من تلك المنصة. يتحمل الشريك وحده التزاماته الضريبية والاجتماعية. تُحفظ البيانات المصرفية المقدَّمة مشفَّرة ولا تُعرض كاملة أبدًا، ولا حتى لصاحبها: تبقى الأحرف الأولى والأخيرة فقط مقروءة للتعرف عليها. ولتعديلها، يعيد الشريك إدخالها."] },
