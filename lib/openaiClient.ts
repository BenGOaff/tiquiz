...
export function getOwnerOpenAI(): OpenAI | null {
  // Tiquiz : clé OpenAI dédiée à la génération d'images du studio.
  const apiKey = process.env.OPENAI_API_KEY || process.env.OPENAI_API_KEY_OWNER;
...
export const OPENAI_MODEL =
  process.env.TIQUIZ_OPENAI_MODEL?.trim() ||
