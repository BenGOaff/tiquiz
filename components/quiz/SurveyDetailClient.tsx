...
type QuestionType =
  ...
  | "image_choice"
  | "yes_no";
type QuizOption = { text: string; result_index: number; image_url?: string | null; image_width?: number | null; sio_tag_name?: string | null; is_other?: boolean | null; other_placeholder?: string | null };
type QuizQuestion = {
  id?: string;
