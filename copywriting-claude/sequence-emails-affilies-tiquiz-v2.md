# Séquence emails affiliés Tiquiz — V2 evergreen (avec offres PLUS)

8 emails à envoyer à ta liste pour présenter Tiquiz et toucher ta commission affiliée. Cadence recommandée : 1 mail tous les 2 jours, ou 1 par semaine sur 2 mois.

*Wording neutre, adaptable à toutes les niches (coachs, formateurs, affiliés, créateurs, agences). Posture "partenaire qui recommande", aucun vocabulaire IA ou bro.*

---

## Mode d'emploi — à lire avant d'envoyer

- **URL à connaître** (à tracker avec ton ID affilié) :
  - Page de vente Tiquiz : `https://www.tipote.fr/part-tiquiz?sa=TON_ID_AFFILIE`
  - Remplace `TON_ID_AFFILIE` par ton ID Systeme.io (celui qui commence par "sa…"). Sans ça, tu ne seras pas tracké sur la commission.

- Remplace `[TON_PRÉNOM]` par ton prénom dans les signatures.
- La variable `{first_name}` est celle de Systeme.io. Adapte si tu utilises un autre outil.
- Les emails sont rédigés avec la posture "Béné est ma partenaire / mon amie / une créatrice que je suis". Jamais "je touche une commission". Tu fais ce que tu veux avec ça, selon ta ligne.
- Si tu veux être transparent sur le partenariat : ajoute en PS "On est partenaires, Béné et moi" — ta liste t'en aimera probablement plus, pas moins.
- Tu peux adapter ton ton (tutoiement / vouvoiement, familier / pro). Le squelette reste valide.

---

## Rappel offre Tiquiz V2 (à ne pas modifier)

Tiquiz est un SaaS de création de quiz marketing avec IA et synchronisation native Systeme.io. **Cinq plans** maintenant disponibles, regroupés en 2 familles.
...
- **Multi-profils** : crée autant de profils de clients que tu en accompagnes (1 espace = 1 client = 1 branding distinct).
- **Analyse IA des résultats** : pour chaque quiz, Tiquiz te livre des insights stratégiques sur ton audience captée. Tu sais ce qui motive, ce qui freine, ce qui convertit, sans te taper l'analyse à la main.
- **Multi-clés API Systeme.io** : connecte autant de comptes Systeme.io que tu gères. Chaque quiz envoie ses leads dans le bon compte client, automatiquement.
- **Templates de quiz** : pars d'un template pré-conçu, adapte en quelques clics. Idéal quand tu lances 10 quiz par mois pour 10 clients différents.

Tarifs PLUS :

- **Mensuel PLUS — 29 €/mois** sans engagement.
- **Annuel PLUS — 290 €/an** : 2 mois offerts vs le mensuel PLUS.

### Posture commerciale (à respecter)

Pas de garantie, pas de remboursement. C'est la posture assumée de Béné. Le compte gratuit est là pour que les hésitants testent en conditions réelles avant de payer un centime. Si on hésite après ça, ce n'est pas le bon outil pour soi, et c'est OK.

---

## Calendrier d'envoi suggéré

| # | Angle | Mission |
|---|-------|---------|
| 1 | Ouverture | Présenter Béné + Tiquiz, présenter les 5 plans en 2 familles |
| 2 | Cascade de bénéfices | Ce que l'outil permet concrètement (STANDARD + PLUS) |
...
**Objet :** Un outil que je voulais te partager

**Pré-header :** Béné a sorti son SaaS de quiz, et je crois que ça va te parler.

**Angle :** Présenter Béné, présenter Tiquiz, présenter les 5 plans regroupés en 2 familles.
...
**👉 Je découvre Tiquiz →** *[lien : https://www.tipote.fr/part-tiquiz?sa=TON_ID_AFFILIE]*
...
## Email 2 — Cascade de bénéfices

**Objet :** {first_name}, ce que Tiquiz fait vraiment

**Pré-header :** La liste concrète, sans l'habiller.

**Angle :** Puces promesses, bénéfice + conséquence. STANDARD pour tous, PLUS pour ceux qui gèrent du multi-client.
...
**👉 Je teste Tiquiz gratuitement →** *[lien : https://www.tipote.fr/part-tiquiz?sa=TON_ID_AFFILIE]*
...
## Email 3 — Histoire / persona miroir

**Objet :** Le piège du "j'ai une liste mais rien ne se passe"

**Pré-header :** Je vois ce pattern plusieurs fois par mois.

**Angle :** Persona miroir, Before / After / Bridge. (Reste centré sur Linda solopreneur — l'agence aura son tour à l'email 7.)
...
## Email 4 — Démonstration / process

**Objet :** Combien de temps pour créer un quiz dans Tiquiz

**Pré-header :** Étape par étape, chrono en main.

**Angle :** Démystifier le process, rassurer sur la technique. Glisse une mention discrète des templates PLUS pour ceux qui vont en faire beaucoup.
...
**Objet :** 7 questions qui reviennent sur Tiquiz

**Pré-header :** Réponses directes, sans filtre.

**Angle :** Lever les objections technique, comparaison outils, prix, niche, Systeme.io, remboursement, et la nouvelle : "je gère plusieurs clients, c'est quel plan ?".
...
Le plan **PLUS** (29 €/mois ou 290 €/an). Tu débloques :
...
**Angle :** Justification du prix sur les deux familles. Comparaison marché. Économies sur la durée.
...
| Outil | Coût mensuel | Coût annuel | Sync Systeme.io native | Page résultat personnalisée |
|---|---|---|---|---|
...
Les outils marché qui font vraiment du multi-clients propre (multi-workspaces + segmentation + analytics) tournent entre **80 et 300 €/mois** :
- Outgrow agency : ~270 $/mois
- Interact Pro : ~64 $/mois (limité côté workspaces)
- Jotform Gold + middleware : ~80 €/mois total
- Sans compter le coût Zapier/Make pour la sync CRM

| Outil | Coût mensuel | Coût annuel | Multi-comptes CRM | Insights IA |
|---|---|---|---|---|
| Outgrow agency | ~250 € | ~3 000 € | Limité | Non |
| Interact Pro | ~60 € | ~720 € | Limité | Non |
| **Tiquiz Mensuel PLUS** | **29 €** | **348 €** | **Oui (Systeme.io)** | **Oui** |
| **Tiquiz Annuel PLUS** | — | **290 €** | **Oui (Systeme.io)** | **Oui** |

Réel sur 5 ans en PLUS :
- Outgrow agency : ~15 000 €
- Interact Pro : ~3 600 €
...
Demain, je te montre deux cas d'usage concrets : un solo, un agence. Tu choisis celui qui te ressemble.

[TON_PRÉNOM]

---

## Email 7 — Cas d'usage concret

**Objet :** Le quiz qui pré-vend ton offre (et la rampe de lancement pour agence)

**Pré-header :** Deux exemples concrets, deux familles de plans.

**Angle :** Démontrer la mécanique de pré-vente avec Marie (solo) ET la mécanique d'agence avec Karim (multi-clients).
...
**Ce qu'il fait avec Tiquiz PLUS**

Karim crée un espace par client (multi-profils). Pour chacun :
...
**Objet :** {first_name}, les 5 chemins possibles

**Pré-header :** Récap. La décision te revient.

**Angle :** Récap des 5 plans, deux familles. Aucune urgence artificielle. Posture "tu décides".
...
Coût : 29 €/mois. Soit environ 4 € par client si tu en gères 7-8.
...
Coût : 290 €/an. Amorti dès le premier setup client du mois si tu factures tes prestations.
...
## Notes pour l'affilié

### Comment personnaliser sans casser le ton

- Si tu connais bien Béné personnellement, tu peux remplacer "Béné" par "mon amie Béné", "ma partenaire Béné", ou "une créatrice que je suis depuis longtemps". Garde ce qui est vrai pour toi.
- Si tu as testé Tiquiz toi-même, ajoute une phrase perso dans l'email 2 ou 4 ("moi je m'en sers pour…", "j'ai testé sur tel cas…").
- Évite "j'ai négocié un prix exclusif pour toi" — c'est faux, le prix est le même pour tout le monde. Tu trompes ta liste et tu prends un risque CGV.
- Garde les objets courts (45-55 caractères max). Les pré-headers complètent l'objet, pas le répètent.

### Si ta liste est 100 % solopreneur (zéro agence)

Tu peux retirer les blocs PLUS des emails 1, 2, 4, 5, 6 et 8, et garder seulement le cas Marie dans l'email 7. Sequence plus courte, plus ciblée, conversion potentiellement meilleure.

### Si ta liste est 100 % agence / consultants / freelances multi-clients

Inverse : retire les blocs STANDARD et le cas Linda. Garde uniquement Karim dans l'email 7. Centre toute la séquence sur les bénéfices PLUS et l'amortissement client.

### Sur la question de la transparence affiliation

Tu n'es pas obligé·e de révéler le partenariat. Tu n'es pas obligé·e de le cacher non plus. Si tu veux jouer la transparence (souvent payant sur une liste fidèle), ajoute en PS du mail 1 ou du mail 8 une ligne du type :

> "PS : Béné et moi sommes partenaires sur cette offre. Ça ne change rien au prix que tu payes, et je ne t'en aurais pas parlé si je ne croyais pas au produit."

Cette phrase est optionnelle. Si tu la mets, ta liste te respectera souvent davantage. Si tu ne la mets pas, tu restes dans les clous tant que ta recommandation est sincère.
